...
const AddCategories = () => {
    ...
    return (
        <div id="main" className="main" style={{ padding: '20px' }}>
            <div>
                <hr />
                <h2 style={{ textAlign: 'center', color: 'rgb(14, 42, 71)' }}>Add Categories For Vendor Product</h2>
                <hr />
                <br></br>
                            ...
                            <form>
                                <div class="modal-body">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="recipient-name" placeholder='Enter a Category' />
                                    </div>
