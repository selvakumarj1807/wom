...
import './userHistory.css'; // Keep your CSS file
...
const ViewProducts = () => {
    ...
    const handleBack = () => {
        navigate('/user/user/user_history'); // Navigate to /user/orderVerified
    };
    return (
        <div id="main" className="main" style={{ padding: '20px' }}>
            <div className="invoice">
                <h1 style={{ textAlign: 'center' }}>View Ordered Products</h1>
                ...
                <center>
                    <div className="button-container">
                        <button style={{ backgroundColor: 'rgb(1, 57, 117)', color: 'white', width: '200px' }} onClick={handleBack}>
                            Back
                        </button>
                    </div>
                </center>
